...
export default function AdminPage() {
  ...
  function notificationResult(json: Record<string, unknown>, successText: string) {
    const warnings = [json.emailWarning].filter(Boolean).join(" ");
    if (warnings) setError(`${successText} Ancak: ${warnings}`);
    else if (json.emailSent) setNotice(`${successText} Kullanıcıya e-posta gönderildi.`);
